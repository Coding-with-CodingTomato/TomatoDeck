export const en = {
  ...
  obs_settings: {
    ...
    connection_desc: 'Connect to your OBS Websocket Server',
  },
  twitch_settings: {
    title: 'Twitch Settings',
    connection: 'Twitch Connection',
    connection_desc: 'Connect to the Twitch API',
    chatCreds: 'Chat Action Settings',
    channelName: 'Username',
    channelNameDesc: 'Username from which messages will be sent',
